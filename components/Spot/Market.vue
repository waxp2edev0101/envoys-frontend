  ...
  export default {
    ...
    methods: {
      ...
      getPairs(symbol) {
        ...
        this.$axios.$post(this.$api.provider.getPairs, { symbol: (symbol ?? this.parse.base()), type: 'spot' }).then((response) => {
       ...
       */
      getMarkers() {
        this.$axios.$post(this.$api.provider.getMarkers, { type: 'spot' }).then((response) => {
