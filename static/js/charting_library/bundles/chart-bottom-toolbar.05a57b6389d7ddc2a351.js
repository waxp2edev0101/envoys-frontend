(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[7260], {
  67891: function (e, t) {
    var n, i, s;
    i = [t], void 0 === (s = "function" == typeof (n = function (e) {
      "use strict";
      ...
      var s = "undefined" != typeof window && window.navigator && window.navigator.platform && /iP(ad|hone|od)/.test(window.navigator.platform),
        a = [], o = !1, r = -1, l = void 0, c = void 0, h = function (e) {
      ...
      e.disableBodyScroll = function (e, i) {
        if (s) {
          ...
          if (e && !a.some((function (t) {
            ...
            a = [].concat(t(a), [u]), e.ontouchstart = function (e) {
              1 === e.targetTouches.length && (r = e.targetTouches[0].clientY)
            }, e.ontouchmove = function (t) {
              var n, i, s, a;
              1 === t.targetTouches.length && (i = e, a = (n = t).targetTouches[0].clientY - r, !h(n.target) && (i && 0 === i.scrollTop && 0 < a || (s = i) && s.scrollHeight - s.scrollTop <= s.clientHeight && a < 0 ? d(n) : n.stopPropagation()))
            }, o || (document.addEventListener("touchmove", d, n ? {passive: !1} : void 0), o = !0)
          }
        } else {
          g = i, setTimeout((function () {
            if (void 0 === c) {
              var e = !!g && !0 === g.reserveScrollBarGap, t = window.innerWidth - document.documentElement.clientWidth;
        ...
        })), o && (document.removeEventListener("touchmove", d, n ? {passive: !1} : void 0), o = !1), a = [], r = -1) : (u(), a = [])
      }, e.enableBodyScroll = function (e) {
        if (s) {
          if (!e) return void console.error("enableBodyScroll unsuccessful - targetElement must be provided when calling enableBodyScroll on IOS devices.");
          e.ontouchstart = null, e.ontouchmove = null, a = a.filter((function (t) {
            return t.targetElement !== e
          })), o && 0 === a.length && (document.removeEventListener("touchmove", d, n ? {passive: !1} : void 0), o = !1)
        } else 1 === a.length && a[0].targetElement === e ? (u(), a = []) : a = a.filter((function (t) {
          return t.targetElement !== e
        }))
      }
    ...
    "use strict";
    n.d(t, {Loader: () => c})
    ;var i, s = n(67294), a = n(94184), o = n(8596), r = n(33214), l = n.n(r);
    !function (e) {
    ...
    class c extends s.PureComponent {
      ...
      render() {
        ...
        return s.createElement("span", {className: a(l().loader, n && l().static, e, this._getStateClass())}, s.createElement("span", {className: i}), s.createElement("span", {className: i}), s.createElement("span", {className: i}))
      }

      componentDidMount() {
        this.setState({state: i.Appear}), this._stateChangeTimeout = setTimeout(() => {
    ...
    function a(e, t) {
      const n = Object.entries(e).filter(t), i = {};
    ...
    var i = n(67294), s = n(73935), a = n(79881), o = n(45697), r = n(94184), l = n(5383), c = n(27490), h = n(67842),
      d = n(19330), u = n(79424), m = n(68521), g = n(95860), p = n(10869), v = n(16282), b = n(87438), _ = n(53178),
      f = n(5729), C = n.n(f), y = n(74645);

    class E {
      constructor(e) {
        this._state = {ranges: []}, this._change = new (C()), this._rangeChangedListenerBound = this._onRangeChanged.bind(this);
        const {chartWidget: t} = this._context = e;
        t.withModel(null, () => {
          const e = t.model(), n = e.mainSeries();
      ...
      selectRange(e) {
        ...
        const {chartWidgetCollection: t} = this._context, n = {val: e.value, res: e.targetResolution};
        t.setTimeFrame(n)
      }
      ...
      destroy() {
        ...
        e.withModel(null, () => {
          const t = e.model(), n = t.mainSeries();
      ...
      _updateAvailableRanges() {
        ...
        const n = t.model().mainSeries(), i = n.status();
      ...
      return (t = class extends i.PureComponent {
        constructor(e, t) {
          super(e, t), this._handleUpdate = e => {
            ...
            var t, n;
            (0, b.trackEvent)("GUI", "Chart Bottom Toolbar", "range " + e.value), null === (n = (t = this.props).onSelectRange) || void 0 === n || n.call(t, e), this._binding.selectRange(e)
    ...
    const M = new WeakMap;
    var w = n(98737), k = n(90590), R = n(10284), T = n(22675), A = n(14561), N = n(39123);

    function B(e) {
      const {ranges: t, activeRange: n, onSelectRange: s} = e;
      return i.createElement(i.Fragment, null, t.map(e => i.createElement(k.ContextMenuItem, {
        key: e.value.value,
    ...
    function W(e) {
      ...
      return i.createElement(i.Fragment, null, i.createElement(R.Separator, {className: N.separator}), i.createElement(k.ContextMenuItem, {
        icon: A,
    ...
    class I extends i.PureComponent {
      constructor(e, t) {
        super(e, t), this._handleGoToDateClick = () => {
          ...
          return e ? i.createElement(i.Fragment, null, i.createElement(B, {
            ranges: t,
            activeRange: n,
            onSelectRange: this._handleRangeSelect
          }), s && i.createElement(W, {onGoToDateClick: this._handleGoToDateClick})) : i.createElement(i.Fragment, null, t.map(e => i.createElement(g.PopupMenuItem, {
            key: e.value.value,
            label: e.description || e.text,
            isActive: n === e.value.value,
            onClick: this._handleRangeSelect,
            onClickArg: e
          })), s && i.createElement(p.PopupMenuSeparator, null), s && i.createElement(g.PopupMenuItem, {
            label: L.goToDate,
      ...
      render() {
        return i.createElement(m.MatchMedia, {rule: "screen and (max-width: 428px)"}, e => i.createElement(h.ToolWidgetMenu, {
          className: N.button,
          content: L.title,
          arrow: !0,
    ...
    const G = x((function (e) {
      ...
      return i.createElement(j, {
        className: r(K.sliderRow, t),
        "data-name": "date-ranges-tabs"
      }, n.map((e, t) => i.createElement(U, {
        key: e.value.value,
        value: e.value.value,
        isFirst: 0 === t,
        isLast: t === n.length - 1,
    ...
    var V = n(49775), X = n(19598), Z = n(42998), Y = n(51496), J = n(81882);
    ...
    var se = n(48729), ae = n(18675), oe = n(46374), re = n(6799);
    ...
    class le extends i.PureComponent {
      constructor(e) {
        super(e), this._element = null, this._menuShown = !1, this._preventShowingMenu = !1, this._handleRef = e => {
          ...
          const {getActions: e} = this.props, t = (0, v.ensureNotNull)(this._element), n = e()
          ;
          ...
          re.ContextMenuManager.showMenu(n, {
            ...
            clientY: i.top,
            attachToYBy: "bottom"
          }, void 0, {menuName: "TimezoneMenuContextMenu"}, () => {
            this._menuShown = !1
          }).then(() => {
            this._menuShown = !0
          })
    ...
    var ce = n(84540), he = n(46305);
    const de = {hint: (0, a.t)("Timezone")};
    const ue = (0, _.registryContextType)();

    class me extends i.PureComponent {
      constructor(e, t) {
        super(e, t), this._timeFormatter = new ae.TimeFormatter, this._tickInterval = void 0, this._tickClock = () => {
      ...
      render() {
        const {className: e, withMenu: t} = this.props, {time: n} = this.state,
          s = void 0 !== this._timezone ? (0, se.parseTzOffset)(this._timezone.name()).string : null;
        return i.createElement(le, {getActions: this._getActions}, i.createElement(ie, {
    ...
    var ve = n(47218), be = n(90963), _e = n(43367);
    ...
    class fe {
      ...
      _setHighlight() {
        const e = this._chartWidget.model().model(), t = e.paneForSource(e.mainSeries()), n = this._priceScaleGetter();
      ...
      _removeHighlight() {
        const e = this._chartWidget.model().model(), t = e.paneForSource(e.mainSeries());
        if (null === t) return;
        const n = this._chartWidget.paneByState(t);
        if (null !== n) {
          const t = n.highlightedPriceAxis(), i = t.value();
    ...
    var ke = n(87230), Re = n(39197), Te = n(93410), Ae = n(17806), Ne = n(80088);
    const Be = {
      extLabel: (0, a.t)("ext"),
    ...
    }, We = (Le = e => i.createElement(ve.ToolWidgetButton, {
      text: Be.logLabel,
      title: Be.logHint,
      ...
      constructor(e, t) {
        super(e, t), this._priceScale = null, this._handleSelect = () => {
          const e = this.context.chartWidget.model(), t = (0, v.ensureNotNull)(this.state.series), n = t.priceScale(),
            i = n.mode();
          t.priceScale().isLockScale() || e.setPriceScaleMode({log: !i.log}, n, ye)
        }, (0, _.validateRegistry)(t, {chartWidget: o.any.isRequired}), this.state = {
          isActive: !1,
          series: null
      ...
      componentDidMount() {
        ...
        e.withModel(null, () => {
          const t = e.model().mainSeries(), n = t.priceScale()
      ...
      render() {
        const {className: e} = this.props, {isActive: t, series: n} = this.state;
    ...
    const Ie = function (e) {
      ...
      return (t = class extends i.PureComponent {
        constructor(e, t) {
          super(e, t), this._priceScale = null, this._handleSelect = () => {
            const e = this.context.chartWidget.model(), t = (0, v.ensureNotNull)(this.state.series).priceScale(),
              n = t.mode();
        ...
        render() {
          const {className: t} = this.props, {isActive: n, series: s} = this.state;
          return i.createElement(e, {
            ...this._priceAxisHighlighter.handlers(),
            className: t,
            isAuto: n,
    ...
    }(e => i.createElement(ve.ToolWidgetButton, {
      text: Be.autoLabel,
      title: Be.autoHint,
      className: e.className,
      isActive: e.isAuto,
      ...
      return (t = class extends i.PureComponent {
        constructor(e, t) {
          super(e, t), this._handleClick = e => {
            ...
            0
          }, (0, _.validateRegistry)(t, {chartWidgetCollection: o.any.isRequired, resizerDetacher: o.any.isRequired});
        ...
        componentDidMount() {
          ...
          } = this.context, {mobileChangeLayoutEnabled: n} = this.props;
        ...
        render() {
          const {className: t} = this.props, {isFullscreen: n, isChangeLayoutButton: s} = this.state;
    ...
    })), Ue = {properties: !0, fullscreen: !0, preventPhoneLayout: !0}, He = {
    ...
    class Ve extends i.PureComponent {
      constructor(e, t) {
        var n, a;
        super(e, t), this._timezoneButtonRef = null, this._layout = Object.assign({}, je), this._raf = null, this._toolbar = null, this._rangeExpanded = null, this._rangeCollapsed = null, this._seriesComponents = {}, this._injector = (n = () => this._layout, a = (e, t) => this._seriesComponents[t] = e, (e, t, s) => {
          if (i.isValidElement(e) && "string" != typeof e.type) {
            const {props: o} = e;
            if ("string" == typeof o.className) {
              const l = {className: r(o.className, 0 === t && Ne.first, t === s.length - 1 && Ne.last)}, c = n(),
          ...
          null === this._raf && (this._raf = requestAnimationFrame(() => {
            const e = this._layout, t = (0, v.ensureNotNull)(this._toolbar),
              n = (0, v.ensureNotNull)(this._rangeExpanded), i = (a = function (e) {
                const t = {};
            ...
            var a;
            const o = t.offsetWidth, r = i.reduce((e, t) => e + t.width, 0), l = n.offsetWidth,
            ...
            if (Object.assign(e, {dateRangeMode: c}), "expanded" !== c) {
              ...
              let n = 0, s = 0;
              for (const a of i) n += a.width, a.name in Ue ? (s += a.width, Object.assign(e, {[a.name]: !1})) : Object.assign(e, {[a.name]: t <= n});
      ...
      render() {
        ...
        }, t && i.createElement(ke.FragmentMap, null, i.createElement("div", {
          className: r(Ne.dateRangeWrapper, "collapsed" !== e.dateRangeMode && Ne.collapsed),
          ref: this._handleRangeCollapsedRef
        }, i.createElement("div", {className: r(Ne.dateRangeCollapsed)}, i.createElement(z, {goToDateButton: this.props.goToDateEnabled}))), i.createElement(l, {onMeasure: this._handleMeasure}, i.createElement("div", {
          className: r(Ne.dateRangeWrapper, "expanded" !== e.dateRangeMode && Ne.collapsed),
          ref: this._handleRangeExpandedRef
        }, i.createElement("div", {className: r(Ne.dateRangeExpanded)}, i.createElement(G, {onSelectRange: this._trackRangeButtonClick}), this.props.goToDateEnabled && i.createElement(pe, null), this.props.goToDateEnabled && i.createElement(te, null))))), i.createElement("div", {className: Ne.seriesControlWrapper}, n && i.createElement(l, {onMeasure: this._handleMeasure}, i.createElement("div", {
        ...
        }, i.createElement(pe, null)), i.createElement(ke.FragmentMap, {map: this._injector}, !1, !1, !1, s && !c.enabled("fundamental_widget") && i.createElement(ze, {className: Ne.icon}), a && i.createElement(We, {className: Ne.item}), o && i.createElement(Ie, {className: Ne.item}), h && this.state.isFullscreenable && i.createElement(Fe, {
          className: Ne.icon,
      ...
      _applyResizing() {
        ...
        this._rangeExpanded && this._rangeExpanded.classList.toggle(Ne.collapsed, "expanded" !== e), this._rangeCollapsed && this._rangeCollapsed.classList.toggle(Ne.collapsed, "collapsed" !== e), Object.keys(t).forEach(e => {
          const n = e, i = this._seriesComponents[n];
    ...
    class Ze extends i.PureComponent {
      ...
      render() {
        ...
        return i.createElement(_.RegistryProvider, {
          validation: Xe,
    ...
    var i = n(67294), s = n(45697), a = n.n(s);
    ...
    function i(e, t, n, i, s) {
      ...
      return s.click && i.addEventListener("click", a, !1), s.mouseDown && i.addEventListener("mousedown", a, !1), s.touchEnd && i.addEventListener("touchend", a, !1), s.touchStart && i.addEventListener("touchstart", a, !1), () => {
    ...
    "use strict";
    n.d(t, {Hint: () => r});
    var i = n(67294), s = n(94184), a = n.n(s), o = n(30160);
    ...
    var i = n(67294), s = n(94184), a = n.n(s), o = n(49775), r = n(73226), l = n(23060), c = n(57330), h = n(12343),
      d = n(655), u = n(37978), m = n(85848);
    ...
    function g(e) {
      const {
        ...
        jsxLabel: w,
        size: k = "normal"
      } = e, R = (0, i.useContext)(l.EmptyIconsContext), T = !!y.length;
      return n ? i.createElement("li", {className: a()(m.item, m.loading, m[k])}, i.createElement(r.Loader, null)) : i.createElement("li", {
        className: a()(m.item, m.interactive, t && m.title, v && m.disabled, s && m.hovered, g && m.active, R && m.emptyIcons, m[k]),
        onClick: S
      }, i.createElement(o.Icon, {
        className: a()(m.icon), icon: function () {
          if (p && b) return f || _ || h;
          return _
        }()
      }), i.createElement("span", {className: a()(m.label)}, null != w ? w : E), !!M && i.createElement(o.Icon, {
        onClick: function () {
          M && M.action()
        }, className: m.remove, icon: u
      }), !T && C && i.createElement(c.Hint, {
        className: m.shortcut,
        text: C
      }), T && i.createElement(o.Icon, {className: m.nested, icon: d}), x)
    }
  }, 23060: (e, t, n) => {
    "use strict";
    ...
    "use strict";
    n.d(t, {Separator: () => o});
    var i = n(67294), s = n(94184), a = n(68552);
    ...
    var i = n(67294), s = n(94184), a = n(79424), o = n(87438), r = n(74818), l = n(66549);
    const c = l;

    function h(e) {
      const {reference: t, ...n} = e, s = {...n, ref: t};
    ...
    function u(e) {
      const {
        ...
        theme: W = l
      } = e, L = (0, r.filterDataProps)(e), D = (0, i.useRef)(null);
      return i.createElement(h, {
        ...
        onMouseOver: N,
        onMouseOut: A
      }, void 0 !== _ && i.createElement("div", {
        className: W.icon,
        dangerouslySetInnerHTML: {__html: _}
      }), i.createElement("div", {className: s(W.labelRow, g)}, i.createElement("div", {className: s(W.label, p)}, S)), (void 0 !== v || b) && i.createElement("div", {className: W.shortcut}, (I = v) && I.split("+").join(" + ")), void 0 !== R && i.createElement("div", {
        onClick: B ? d : void 0,
    ...
    var i = n(67294), s = n(94184), a = n.n(s), o = n(78706);

    function r(e) {
      const {size: t = "normal", className: n} = e;
      return i.createElement("div", {className: a()(o.separator, "small" === t && o.small, "normal" === t && o.normal, "large" === t && o.large, n)})
    }
  }, 76420: (e, t, n) => {
    "use strict";
    n.d(t, {PopupMenu: () => c});
    var i = n(67294), s = n(73935), a = n(4735), o = n(90901), r = n(94884), l = n(47165);
    ...
    function c(e) {
      const {
        ...
        onClose: m,
        ...g
      } = e, p = (0, i.useContext)(r.CloseDelegateContext), v = (0, l.useOutsideEvent)({
        handler: function (e) {
          u && u(e);
          if (!h) return;
          ...
          m()
        }, mouseDown: !0, touchStart: !0
      });
      return c ? i.createElement(a.Portal, {
        top: "0",
        left: "0",
        right: "0",
        bottom: "0",
        pointerEvents: "none"
      }, i.createElement("span", {ref: v, style: {pointerEvents: "auto"}}, i.createElement(o.Menu, {
        ...g,
        onClose: m,
        onScroll: function (t) {
          const {onScroll: n} = e;
    ...
    ;var i = n(67294), s = n(94184), a = n(16282), o = n(16929);
    const r = o;
    ...
    function c(e) {
      return class extends i.PureComponent {
        ...
        render() {
          const {className: t} = this.props, n = this._generateTabs();
          return i.createElement("div", {
            className: s(t, o.tabs),
        ...
        _generateTabs() {
          return this.activeTab.current = null, i.Children.map(this.props.children, e => {
            const t = e, n = Boolean(t.props.isActive), s = {
              reference: e => {
        ...
        _componentDidUpdate() {
          ...
          if (this.activeTab.current) {
            const t = this.activeTab.current.offsetWidth, n = this.activeTab.current.offsetLeft;
